...
$query2 = "SELECT * FROM `bank_deposit` where customer_id = $customer_id and transaction='Received'";
...
$query2 = "SELECT * FROM `bank_deposit` where customer_id = $customer_id and transaction='Sent'";
$a2 = mysqli_query($con, $query2);
$b2 = mysqli_num_rows($a2);
